...
@Client.on_message(filters.command(["stats", "gstats"]) & ~KATIL_USERS)
@language
...
@Client.on_callback_query(filters.regex("stats_back") & ~KATIL_USERS)
@languageCB
...
@Client.on_callback_query(filters.regex("TopOverall") & ~KATIL_USERS)
@languageCB

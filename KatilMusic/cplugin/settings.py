...
@Client.on_callback_query(filters.regex("settings_helper") & ~KATIL_USERS)
@languageCB
...
@Client.on_callback_query(filters.regex("settingsback_helper") & ~KATIL_USERS)
@languageCB
...
@Client.on_callback_query(filters.regex("FERRARIUDTI") & ~KATIL_USERS)
@ActualAdminCB
...
@Client.on_callback_query(filters.regex(pattern=r"^(AUTH|AUTHLIST)$") & ~KATIL_USERS)
@ActualAdminCB
...
@Client.on_callback_query(filters.regex("VOMODECHANGE") & ~KATIL_USERS)
@ActualAdminCB

...
from KatilMusic.utils.formatters import convert_bytes
from KatilMusic.utils.inline.song import song_markup
...
@app.on_callback_query(filters.regex(pattern=r"song_back") & ~KATIL_USERS)
@languageCB
...
@app.on_callback_query(filters.regex(pattern=r"song_helper") & ~KATIL_USERS)
@languageCB
...
@app.on_callback_query(
    filters.regex(pattern=r"song_download") & ~KATIL_USERS
)
@languageCB

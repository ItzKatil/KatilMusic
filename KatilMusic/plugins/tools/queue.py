...
from KatilMusic.utils import HottyBin, get_channeplayCB, seconds_to_min
...
@app.on_callback_query(filters.regex("GetTimer") & ~KATIL_USERS)
...
@app.on_callback_query(filters.regex("GetQueued") & ~KATIL_USERS)
@languageCB
...
@app.on_callback_query(filters.regex("queue_back_timer") & ~KATIL_USERS)
@languageCB

...
@app.on_message(filters.command(["help"]) & filters.private & ~KATIL_USERS)
@app.on_callback_query(filters.regex("settings_back_helper") & ~KATIL_USERS)
...
@app.on_message(filters.command(["help"]) & filters.group & ~KATIL_USERS)
@LanguageStart
...
@app.on_callback_query(filters.regex("help_callback") & ~KATIL_USERS)
@languageCB
...
@app.on_callback_query(filters.regex("dilXaditi") & ~KATIL_USERS)
@languageCB

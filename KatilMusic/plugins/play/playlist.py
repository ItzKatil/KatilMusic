...
@app.on_message(filters.command(PLAYLIST_COMMAND) & ~KATIL_USERS)
@language
...
@app.on_message(filters.command(DELETEPLAYLIST_COMMAND) & ~KATIL_USERS)
@language
...
@app.on_callback_query(filters.regex("play_playlist") & ~KATIL_USERS)
@languageCB
...
@app.on_message(filters.command(ADDPLAYLIST_COMMAND) & ~KATIL_USERS)
@language
...
@app.on_callback_query(filters.regex("open_playlist") & ~KATIL_USERS)
@languageCB
...
@app.on_callback_query(filters.regex("remove_playlist") & ~KATIL_USERS)
@languageCB
...
@app.on_callback_query(filters.regex("recover_playlist") & ~KATIL_USERS)
@languageCB
...
@app.on_callback_query(filters.regex("add_playlist") & ~KATIL_USERS)
@languageCB
async def add_playlist(client, CallbackQuery, _):
    await CallbackQuery.answer(
...
@app.on_callback_query(filters.regex("branded_playlist") & ~KATIL_USERS)
@languageCB
...
@app.on_message(filters.command(DELETE_ALL_PLAYLIST_COMMAND) & ~KATIL_USERS)
@language
...
@app.on_callback_query(filters.regex("del_playlist") & ~KATIL_USERS)
@languageCB
async def del_plist(client, CallbackQuery, _):
    pass
...
@app.on_callback_query(filters.regex("delete_whole_playlist") & ~KATIL_USERS)
@languageCB
...
@app.on_callback_query(filters.regex("get_playlist_playmode") & ~KATIL_USERS)
@languageCB
...
@app.on_callback_query(filters.regex("delete_warning") & ~KATIL_USERS)
@languageCB
...
@app.on_callback_query(filters.regex("home_play") & ~KATIL_USERS)
@languageCB
...
@app.on_callback_query(filters.regex("del_back_playlist") & ~KATIL_USERS)
@languageCB

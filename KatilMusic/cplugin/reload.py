...
from KatilMusic.mongo.afkdb import LOGGERS
...
@Client.on_message(filters.command(["reboot"]) & filters.group & ~KATIL_USERS)
@AdminActual
...
@Client.on_callback_query(filters.regex("close") & ~KATIL_USERS)
...
@Client.on_callback_query(filters.regex("stop_downloading") & ~KATIL_USERS)
@ActualAdminCB

...
from KatilMusic.utils import bot_up_time
...
from KatilMusic.utils.inline import first_page, private_panel, start_panel
...
@Client.on_message(filters.command(["start"]) & filters.private & ~KATIL_USERS)
@LanguageStart
...
@Client.on_message(filters.command(["start"]) & filters.group & ~KATIL_USERS)
@LanguageStart

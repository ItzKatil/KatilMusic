...
from KatilMusic.utils import close_markup
from config import KATIL_USERS, SERVER_PLAYLIST_LIMIT
from KatilMusic import Carbon, app
from KatilMusic.utils.decorators.language import language, languageCB
from KatilMusic.utils.inline.playlist import (
    botplaylist_markup,
    get_playlist_markup,
    warning_markup,
)
from KatilMusic.utils.pastebin import HottyBin
import time
import asyncio
import yt_dlp
...
@Client.on_message(filters.command(PLAYLIST_COMMAND) & ~KATIL_USERS)
@language
...
@Client.on_message(filters.command(DELETEPLAYLIST_COMMAND) & ~KATIL_USERS)
@language
...
@Client.on_callback_query(filters.regex("play_playlist") & ~KATIL_USERS)
@languageCB
...
@Client.on_message(
    filters.command(["playplaylist", "vplayplaylist"]) & ~KATIL_USERS & filters.group
)
@languageCB
...
@Client.on_message(filters.command(["addplaylist", "addplist"]) & ~KATIL_USERS)
@language
async def add_playlist_clone(client: Client, message: Message, _):
    ...
    if "https://youtu.be" in query:
        ...
        from KatilMusic import YouTube
...
@Client.on_callback_query(filters.regex("open_playlist") & ~KATIL_USERS)
@languageCB
...
@Client.on_callback_query(filters.regex("remove_playlist") & ~KATIL_USERS)
@languageCB
...
@Client.on_callback_query(filters.regex("recover_playlist") & ~KATIL_USERS)
@languageCB
...
@Client.on_callback_query(filters.regex("add_playlist") & ~KATIL_USERS)
@languageCB
async def add_playlist_clone(client, CallbackQuery, _):
    await CallbackQuery.answer(
...
@Client.on_callback_query(filters.regex("Brandrd_playlist") & ~KATIL_USERS)
@languageCB
...
@Client.on_message(filters.command(DELETE_ALL_PLAYLIST_COMMAND) & ~KATIL_USERS)
@language
...
@Client.on_callback_query(filters.regex("del_playlist") & ~KATIL_USERS)
@languageCB
...
@Client.on_callback_query(filters.regex("delete_whole_playlist") & ~KATIL_USERS)
@languageCB
...
@Client.on_callback_query(filters.regex("get_playlist_playmode") & ~KATIL_USERS)
@languageCB
...
@Client.on_callback_query(filters.regex("delete_warning") & ~KATIL_USERS)
@languageCB
...
@Client.on_callback_query(filters.regex("home_play") & ~KATIL_USERS)
@languageCB
...
@Client.on_callback_query(filters.regex("del_back_playlist") & ~KATIL_USERS)
@languageCB

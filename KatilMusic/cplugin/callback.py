...
@Client.on_callback_query(filters.regex("PanelMarkup") & ~KATIL_USERS)
@languageCB
...
@Client.on_callback_query(filters.regex("MainMarkup") & ~KATIL_USERS)
@languageCB
...
@Client.on_callback_query(filters.regex("MusicMarkup") & ~KATIL_USERS)
@languageCB
...
@Client.on_callback_query(filters.regex("Pages") & ~KATIL_USERS)
@languageCB
...
@Client.on_callback_query(filters.regex("ADMIN") & ~KATIL_USERS)
@languageCB
async def del_back_playlist(client, CallbackQuery, _):

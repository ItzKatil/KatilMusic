...
from config import KATIL_USERS, adminlist


@Client.on_message(filters.command("auth") & filters.group & ~KATIL_USERS)
@AdminActual
...
@Client.on_message(filters.command("unauth") & filters.group & ~KATIL_USERS)
@AdminActual
...
@Client.on_message(
    filters.command(["authlist", "authusers"]) & filters.group & ~KATIL_USERS
)
@language

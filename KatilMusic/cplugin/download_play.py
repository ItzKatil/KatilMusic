...
@Client.on_callback_query(filters.regex("downloadvideo") & ~filters.user(KATIL_USERS))
...
@Client.on_callback_query(filters.regex("downloadaudio") & ~filters.user(KATIL_USERS))

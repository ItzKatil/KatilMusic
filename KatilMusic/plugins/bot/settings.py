...
from config import KATIL_USERS, OWNER_ID, MUSIC_BOT_NAME, START_IMG_URL


@app.on_message(
    filters.command(["settings", "setting"]) & filters.group & ~KATIL_USERS
)
@language
...
@app.on_callback_query(filters.regex("gib_source") & ~KATIL_USERS)
@languageCB
...
@app.on_callback_query(
    filters.regex("settings_helper") & ~KATIL_USERS
)
@languageCB
...
@app.on_callback_query(filters.regex("settingsback_helper") & ~KATIL_USERS)
@languageCB
...
@app.on_callback_query(filters.regex("FERRARIUDTI") & ~KATIL_USERS)
@ActualAdminCB
...
@app.on_callback_query(filters.regex(pattern=r"^(AUTH|AUTHLIST)$") & ~KATIL_USERS)
@ActualAdminCB
...
@app.on_callback_query(filters.regex("VOMODECHANGE") & ~KATIL_USERS)
@ActualAdminCB

...
from KatilMusic.utils.database import get_served_chats_clone
from KatilMusic import userbot
from KatilMusic.core.mongo import mongodb, pymongodb
...
🔐ᴜꜱᴇ » [/start](https://t.me/KatilMusicBot?start=help) ᴛᴏ ᴄʜᴇᴄᴋ ʙᴏᴛ
...
BUTTON = InlineKeyboardMarkup(
    [
        [
            InlineKeyboardButton(
                "๏ ᴋɪᴅɴᴀᴘ ᴍᴇ ๏",
                url=f"https://t.me/KatilMusicBot?startgroup=s&admin=delete_messages+manage_video_chats+pin_messages+invite_users",
            )
        ]
    ]
)

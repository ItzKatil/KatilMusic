...
from KatilMusic.utils.database import get_assistant
import config
...
from KatilMusic.utils.inline import panel_markup_clone
...
from KatilMusic.utils.decorators.play import CPlayWrapper
...
from config import KATIL_USERS, lyrical
...
@Client.on_callback_query(filters.regex("MusicStream") & ~KATIL_USERS)
@languageCB
...
@Client.on_callback_query(filters.regex("BrandedmousAdmin") & ~KATIL_USERS)
...
@Client.on_callback_query(filters.regex("BrandedPlaylists") & ~KATIL_USERS)
@languageCB
...
@Client.on_callback_query(filters.regex("slider") & ~KATIL_USERS)
@languageCB
...
import config
from KatilMusic import Carbon, YouTube
from KatilMusic.core.call import Hotty
